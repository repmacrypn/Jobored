...
export const Pagination = ({
  ...
  return (
    <ReactPaginate
      previousLabel={
        <ChevronLeft className={s.icon} viewBox='0 0 24 24' height={14} width={20} />
      }
      nextLabel={
        <ChevronRight className={s.icon} viewBox='-2 0 24 24' height={14} width={20} />
      }
      breakLabel={null}
      pageCount={pageCount}
